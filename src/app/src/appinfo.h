// Iwer Petersen. Copyright (C) <Copyright Year(s)>. <License>.
...
#define APPLICATION_NAME               "I²E User Reconstruction"
#define APPLICATION_CODENAME           "i2e-user-reconstruction"
...
#define APPLICATION_VENDOR_ID          "de.haw-hamburg.informatik.i2e"
#define APPLICATION_VENDOR_NAME        "Immersive Interactive Environments"
#define APPLICATION_VENDOR_URL         "feldschmiederei.de"
#define APPLICATION_ID                 "de.haw-hamburg.informatik.i2e"
